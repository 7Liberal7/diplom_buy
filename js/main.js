...
document.querySelector('.benefits__item1').addEventListener('click', item1);

function item1() {
  document.querySelector('.benefits__item-text1').classList.toggle('benefits__item--acitve');
}

document.querySelector('.btn900').addEventListener('click', btn900);
...
document.querySelector('.btn901').addEventListener('click', btn901);
...
document.querySelector('.btn902').addEventListener('click', btn902);
...
document.querySelector('.btn903').addEventListener('click', btn903);
...
document.querySelector('.btn904').addEventListener('click', btn904);
